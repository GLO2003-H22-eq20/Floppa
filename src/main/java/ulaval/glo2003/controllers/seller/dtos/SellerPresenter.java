...
public class SellerPresenter {
    public SellerResponse presentSeller(SellerDto sellerDto) {
        return new SellerResponse(sellerDto.getId(),
                                  sellerDto.getName(),
                                  sellerDto.getCreatedAt(),
                                  sellerDto.getBio(),
                                  presentProducts(sellerDto.getProducts()));
    }

    public List<ProductResponse> presentProducts(List<Product> productList) {
        return productList.stream().map(product -> new ProductResponse(product.getId(),
